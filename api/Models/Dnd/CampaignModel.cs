...
public class CampaignModel
{
    ...
    [MaxLength(50)] public string Theme { get; set; } = "amber";
    ...
    public virtual ICollection<MapModel> Maps { get; set; } = new List<MapModel>();
    ...
    // Ownership
    [Required] public Guid DungeonMasterId { get; set; }

    [ForeignKey(nameof(DungeonMasterId))] public virtual UserInfoModel DungeonMaster { get; set; } = null!;
